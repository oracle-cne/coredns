...
unset GOPROXY
pushd %{build_dir}
GIT_COMMIT_SHA=$(curl -s https://api.github.com/repos/coredns/coredns/git/refs/tags/v1.13.0 | jq -r '.object.sha[0:7]')
...
%changelog
* Wed Oct 08 2025 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 1.13.0-1
