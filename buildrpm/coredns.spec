...
unset GOPROXY
pushd %{build_dir}
GIT_COMMIT_SHA=$(curl -s https://api.github.com/repos/coredns/coredns/git/refs/tags/v1.14.1 | jq -r '.object.sha[0:7]')
...
%changelog
* Thu Jan 22 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 1.14.1-1
